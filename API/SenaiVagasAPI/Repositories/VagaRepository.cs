...
namespace SenaiVagasAPI.Repositories
{
    public class VagaRepository : IVagaRepository
    {
        ...
        public void Cadastrar(CadastroVagaViewModel novaVaga)
        {
            Vaga applicant = new Vaga()
            {
                Descricao = novaVaga.Descricao,
                Habilidades = novaVaga.Habilidades,
            ...
            FormaContratacao fm = new FormaContratacao()
            {
                Forma = novaVaga.NomeForma
            };

            applicant.FkFormaContratacaoNavigation = fm;
        }
